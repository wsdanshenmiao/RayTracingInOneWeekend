...
namespace DSM {
    ...
    struct Hittable
    {
        ...
        virtual float PDFValue(const Vector3f& origin, const Vector3f& direction) const { return 0.f; }
        virtual Vector3f Random(const Vector3f& origin) const { return Vector3f{1,0,0}; }
    };
